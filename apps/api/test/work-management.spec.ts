...
describe("work management", () => {
  ...
  it("creates a test plan and starts a linked real execution", async () => {
    ...
    expect(JSON.parse(executionResponse.body)).toEqual(expect.objectContaining({ status: "running", environment: "staging", buildReference: "1.2.0", testPlanItemId: item.id }));
  });
