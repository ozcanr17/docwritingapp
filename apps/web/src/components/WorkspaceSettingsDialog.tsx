...
import { Boxes, FileCog, Plug, RotateCcw, ShieldCheck, SlidersHorizontal, X } from "lucide-react";
...
export function WorkspaceSettingsDialog({ organizationId, workspaceId, documentId, onClose }: { organizationId: string; workspaceId: string; documentId: string | null; onClose: () => void }) {
  ...
  const [tab, setTab] = useState<"document" | "authoring" | "configurations" | "integrations" | "sso">("authoring");
